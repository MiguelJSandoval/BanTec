 ...
 */
public class ConfirmarTransferencia extends DialogFragment
{
    private EditText usu, contra;
    Confirmacion listener;
    Registro r;

    public ConfirmarTransferencia(Registro r)
    {
        this.r = r;
    }
    ...
    private AlertDialog crearDialogo()
    {
        ...
        View v = inflater.inflate(R.layout.fragment_confirmar_transferencia, null);
        builder.setView(v);
        usu = v.findViewById(R.id.usuConfirmTransfer);
        contra = v.findViewById(R.id.passConfirmTransac);
        Button acept = v.findViewById(R.id.btn_aceptar_transfer);
        Button cancel = v.findViewById(R.id.btn_cancel_transfer);
